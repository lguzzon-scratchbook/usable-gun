...
export default function (__usable_environment) {
	...
	/* BEGIN WRAPPED GUN CODE */ (() => {
		...
		var ws = wsImport.Server;
		var http = httpPlugin(__usable_environment);
				...
				((req, res, next) => {
					...
					return (
						http(req, res, (req, res) => {
							...
							var stream;
							var cb = (res = jsonpPlugin(__usable_environment)(req, res));
			...
			if (
				...
				nodeHttpsImport.globalAgent.maxSockets =
					nodeHttpImport.globalAgent.maxSockets =
						gun.__.opt.maxSockets || Number.POSITIVE_INFINITY;
			}
			gun.wsp.msg =
				gun.wsp.msg ||
				((id) => {
