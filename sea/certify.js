...
export default function (__usable_environment) {
  ...
  SEA.certify =
      ...
      */
		    ...
		    if (!certificants) { return __usable_globalThis.debug.log('No certificant found.') }
		    const expiry =
					opt.expiry &&
		    ...
		    const writeBlock =
					typeof block === 'string'
					  ...
					  : block.write &&
					    ...
					    ? block.write
					    : null
		    if (!readPolicy && !writePolicy) { return __usable_globalThis.debug.log('No policy found.') }
