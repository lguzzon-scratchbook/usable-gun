      ...
      */
      r.write = (file, rad, cb, o) => {
        ...
        f.write = () => {
          ...
          let start
          LOG && (start = Number(new Date())) // comment this out!
        ...
        r.read = (key, cb, o) => {
          ...
          g.ack = (as) => {
            ...
            if (!o.span) {
              ...
              if (last && last > tmp && last.indexOf(tmp) != 0) {
                !o.some && as.ack(g.err, undefined, o)
                return
              }
            }
        ...
        */
        ...
        r.parse = (file, cb, raw) => {
          ...
          p.read = (err, data) => {
            ...
            var start
            LOG && (start = Number(new Date())) // keep this commented out in production!
            if (opt.jsonify) {
              // temporary testing idea
              try {
